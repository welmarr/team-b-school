                ...
                <div class="col-12" id="tool-table">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="m-0 card-title">Create tool</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="modal-add-new-tool-form" method="POST"
                                action="{{ route('secured.admin.tools.store') }}" autocomplete="off">
                                ...
                                <div class="row my-2">
                                    <div class="col-12 form-group">
                                        ...
                                        <textarea class="form-control" id="modal-add-new-tool-form-description" rows="3" name="description">{{ old('description') }}</textarea>
                                ...
                                <div class="row my-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox"
                                            id="modal-add-new-tool-form-tracked" checked name="tracked">
...
@section('js-after-bootstrap')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn dropdown-toggle').removeClass('btn-light').addClass('btn-dark');
        });
    </script>
@endsection
