    ...
    <div class="row my-4" style="margin-top: 50px !important;">
        <div class="col-sm-12 col-md-6 d-flex align-items-center flex-column mt-md-1">
            ...
            <p class="mb-3">If you have any questions, please feel free reach out to our customer
                support team.</p>
            <span class="underline-orange">chris@cincydentrepair.com</span>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-1 mb-3 offset-md-2">
          ...
          <ul class="nav flex-column">
            <li class="nav-item mb-2"><a href="{{ route('home') }}" class="nav-link p-0 text-muted {{ isset($activeMenu) && $activeMenu ==  'home' ? 'underline-orange' : '' }}">Home</a></li>
          </ul>
        </div>
        ...
        <div class="col-1 mb-3">
          ...
          <ul class="nav flex-column">
            <li class="nav-item mb-2"><a href="{{ route('about') }}" class="nav-link p-0 text-muted {{ isset($activeMenu) && $activeMenu ==  'about' ? 'underline-orange' : '' }}">About us</a></li>
          </ul>
        </div>
        ...
        <div class="col-2 mb-3">
          ...
          <ul class="nav flex-column">
            <li class="nav-item mb-2"><a href="{{ route('get-estimate.view') }}" class="nav-link p-0 text-muted {{ isset($activeMenu) && $activeMenu ==  'get-estimate' ? 'underline-orange' : '' }}">Get estimate</a></li>
            <li class="nav-item mb-2"><a href="{{ route('track-repair.view') }}" class="nav-link p-0 text-muted {{ isset($activeMenu) && $activeMenu ==  'track-repair' ? 'underline-orange' : '' }}">Track repair</a></li>
          </ul>
        </div>
      ...
      <div class="d-flex flex-column flex-sm-row justify-content-between py-2 my-4" style="border-top: 1px solid #eb4034 !important">
        ...
        <ul class="list-unstyled d-flex">
          <li class="ms-3"><a class="link-dark" href="https://www.instagram.com/cincydentrepair?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="><svg class="bi" width="16" height="16"><use xlink:href="#instagram"/></svg></a></li>
          <li class="ms-3"><a class="link-dark" href="https://www.facebook.com/profile.php?id=61558731607535"><svg class="bi" width="16" height="16"><use xlink:href="#facebook"/></svg></a></li>
        </ul>
      </div>
</footer>
