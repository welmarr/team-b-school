    ...
    <div class="container">
        ...
        <div class="row my-4">
            <div class="offset-3 col-6">
                ...
                <span class="mb-4 d-block">Enter your request code in the field below to see the latest updates.</span>

                <form method="POST" action="{{ route('unsecured.track-repair.submit') }}">
                    @csrf
                    <div class="row g-3">
                        <div class="col-12">
                            <label for="requestnumber" class="form-label">Request number</label>
                            <input type="text" class="form-control" id="requestnumber" placeholder="M575665ON" name="reference" required>
                        </div>
        ...
        <div class="row my-4" style="margin-top: 150px !important;">
            ...
            <div class="row my-4" style="margin-top: 100px !important;">
                <div class="col-sm-12 col-md-4 d-flex align-items-center flex-column mt-md-1">
                    ...
                    <p class="mb-3">If you have any questions or issues, please feel free to reach out to our customer support team.</p>
                ...
                <div class="col-sm-12 col-md-4 d-flex align-items-center flex-column mt-sm-4 mt-md-1">
                    ...
                    <span class="underline-orange" style="margin-top: 1.5rem !important;">123 Sample St, Sydney NSW 2000 AU</span>
                </div>
            </div>
        </div>
    </div>
